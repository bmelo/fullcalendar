...
return!M||M>a||b>N}function e(a,b){M=a,N=b,U=[];var c=++R,d=Q.length;S=d;for(var e=0;d>e;e++)f(Q[e],c)}function f(b,c){g(b,function(d){var e,f,g,h=a.isArray(b.events);if(c==R){if(d)for(e=0;e<d.length;e++)f=d[e],g=h?f:t(f,b),g&&U.push.apply(U,x(g));S--,S||O(U)}})}function g(b,d){var e,f,h=Ta.sourceFetchers;for(e=0;e<h.length;e++){if(f=h[e].call(I,// this, the Calendar object
b,M.clone(),N.clone(),c.timezone,d),f===!0)
// the fetcher is in charge. made its own async request
return;if("object"==typeof f)
// the fetcher returned a new source. process it
return void g(f,d)}var i=b.events;if(i)a.isFunction(i)?(I.pushLoading(),i.call(I,// this, the Calendar object
M.clone(),N.clone(),c.timezone,function(a){d(a),I.popLoading()})):a.isArray(i)?d(i):d();else{var j=b.url;if(j){var k,l=b.success,m=b.error,n=b.complete;k=a.isFunction(b.data)?b.data():b.data;
// use a copy of the custom data so we can modify the parameters
// and not affect the passed-in object.
var o=a.extend({},k||{}),p=_(b.startParam,c.startParam),q=_(b.endParam,c.endParam),r=_(b.timezoneParam,c.timezoneParam);p&&(o[p]=M.format()),q&&(o[q]=N.format()),c.timezone&&"local"!=c.timezone&&(o[r]=c.timezone),I.pushLoading(),a.ajax(a.extend({},Ab,b,{data:o,success:function(b){b=b||[];var c=$(l,this,arguments);a.isArray(c)&&(b=c),d(b)},error:function(){$(m,this,arguments),d()},complete:function(){$(n,this,arguments),I.popLoading()}}))}else d()}}/* Sources
	-----------------------------------------------------------------------------*/
function h(a){var b=i(a);b&&(Q.push(b),S++,f(b,R))}function i(b){// will return undefined if invalid source
...
c.events=a.map(c.events,function(a){return t(a,c)})),d=0;d<e.length;d++)e[d].call(I,c);return c}}function j(b){Q=a.grep(Q,function(a){return!l(a,b)}),U=a.grep(U,function(a){return!l(a.source,b)}),O(U)}function k(){Q=[],U=[],O(U)}function l(a,b){return a&&b&&m(a)==m(b)}function m(a){// a normalized event source?
// get the primitive
...
a.start=I.moment(a.start),a.end?a.end=I.moment(a.end):a.end=null,y(a,o(a)),// will handle start/end/allDay normalization
O(U)}
// Returns a hash of misc event properties that should be copied over to related events.
function o(b){var c={};return a.each(b,function(a,b){p(a)&&void 0!==b&&Z(b)&&(// a defined non-object
c[a]=b)}),c}
// non-date-related, non-id-related, non-secret
function p(a){return!/^_|^(id|allDay|start|end)$/.test(a)}
// returns the expanded events that were created
function q(a,b){var c,d,e,f=t(a);if(f){for(c=x(f),d=0;d<c.length;d++)e=c[d],e.source||(b&&(P.events.push(e),e.source=P),U.push(e));return O(U),c}return[]}function r(b){var c,d;// inverse=true
// Remove events from array sources.
// This works because they have been converted to official Event Objects up front.
// (and as a result, event._id has been calculated).
for(null==b?// null or undefined. remove all events
b=function(){return!0}:a.isFunction(b)||(c=b+"",b=function(a){return a._id==c}),U=a.grep(U,b,!0),d=0;d<Q.length;d++)a.isArray(Q[d].events)&&(Q[d].events=a.grep(Q[d].events,b,!0));O(U)}function s(b){// not null, not undefined. an event ID
return a.isFunction(b)?a.grep(U,b):null!=b?(b+="",a.grep(U,function(a){return a._id==b})):U}/* Event Normalization
	-----------------------------------------------------------------------------*/
// Given a raw object with key/value properties, returns an "abstract" Event object.
// An "abstract" event is an event that, if recurring, will not have been expanded yet.
// Will return `false` when input is invalid.
// `source` is optional
function t(d,e){var f,g,h,i={};if(c.eventDataTransform&&(d=c.eventDataTransform(d)),e&&e.eventDataTransform&&(d=e.eventDataTransform(d)),
...
i._recurring=!0;else{if(f&&(f=I.moment(f),!f.isValid()))return!1;g&&(g=I.moment(g),g.isValid()||(g=null)),h=d.allDay,void 0===h&&(// still undefined? fallback to default
h=_(e?e.allDayDefault:void 0,c.allDayDefault)),u(f,g,h,i)}return i}
// Normalizes and assigns the given dates to the given partially-formed event object.
// NOTE: mutates the given start/end moments. does not make a copy.
function u(a,b,c,d){d.start=a,d.end=b,d.allDay=c,v(d),Sa(d)}
// Ensures proper values for allDay/start/end. Accepts an Event object, or a plain object with event-ish properties.
// NOTE: Will modify the given object.
function v(a){w(a),a.end&&!a.end.isAfter(a.start)&&(a.end=null),a.end||(c.forceEventDuration?a.end=I.getDefaultEventEnd(a.allDay,a.start):a.end=null)}
// Ensures the allDay property exists and the timeliness of the start/end dates are consistent
function w(a){null==a.allDay&&(a.allDay=!(a.start.hasTime()||a.end&&a.end.hasTime())),a.allDay?(a.start.stripTime(),a.end&&
// TODO: consider nextDayThreshold here? If so, will require a lot of testing and adjustment
a.end.stripTime()):(a.start.hasTime()||(a.start=I.applyTimezone(a.start.time(0))),a.end&&!a.end.hasTime()&&(a.end=I.applyTimezone(a.end.time(0))))}
// If the given event is a recurring event, break it down into an array of individual instances.
// If not a recurring event, return an array with the single original event.
// If given a falsy input (probably because of a failed buildEventFromInput call), returns an empty array.
// HACK: can override the recurring window by providing custom rangeStart/rangeEnd (for businessHours).
function x(b,c,d){var e,f,g,h,i,j,k,l,m,n=[];if(c=c||M,d=d||N,b)if(b._recurring){
// make a boolean hash as to whether the event occurs on each day-of-week
if(f=b.dow)for(e={},g=0;g<f.length;g++)e[f[g]]=!0;// holds the date of the current day
for(
// iterate through every day in the current range
h=c.clone().stripTime();h.isBefore(d);)e&&!e[h.day()]||(i=b.start,j=b.end,k=h.clone(),l=null,i&&(k=k.time(i)),j&&(l=h.clone().time(j)),m=a.extend({},b),u(k,l,!i&&!j,m),n.push(m)),h.add(1,"days")}else n.push(b);return n}/* Event Modification Math
	-----------------------------------------------------------------------------------------*/
...
return c=c||{},c.start||(c.start=b.start.clone()),void 0===c.end&&(c.end=b.end?b.end.clone():null),null==c.allDay&&(c.allDay=b.allDay),v(c),f={start:b._start.clone(),end:b._end?b._end.clone():I.getDefaultEventEnd(b._allDay,b._start),allDay:c.allDay},v(f),g=null!==b._end&&null===c.end,h=e(c.start,f.start),c.end?(i=e(c.end,f.end),j=i.subtract(h)):j=null,a.each(c,function(a,b){p(a)&&void 0!==b&&(l[a]=b)}),k=z(s(b._id),g,c.allDay,h,j,l),{dateDelta:h,durationDelta:j,undo:k}}
...
//
function z(b,c,d,e,f,g){var h=I.getIsAmbigTimezone(),i=[];
// normalize zero-length deltas to be null
return e&&!e.valueOf()&&(e=null),f&&!f.valueOf()&&(f=null),a.each(b,function(b,j){var k,l;k={start:j.start.clone(),end:j.end?j.end.clone():null,allDay:j.allDay},a.each(g,function(a){k[a]=j[a]}),l={start:j._start,end:j._end,allDay:d},v(l),c?l.end=null:f&&!l.end&&(l.end=I.getDefaultEventEnd(l.allDay,l.start)),e&&(l.start.add(e),l.end&&l.end.add(e)),f&&l.end.add(f),h&&!l.allDay&&(e||f)&&(l.start.stripZone(),l.end&&l.end.stripZone()),a.extend(j,g,l),Sa(j),i.push(function(){a.extend(j,k),Sa(j)})}),function(){for(var a=0;a<i.length;a++)i[a]()}}
// Returns an array of events as to when the business hours occur in the given view.
// Abuse of our event system :(
function A(b){var d,e=c.businessHours,f={className:"fc-nonbusiness",start:"09:00",end:"17:00",dow:[1,2,3,4,5],// monday - friday
rendering:"inverse-background"},g=I.getView();// `true` (which means "use the defaults") or an override object
// copy to a new object in either case
// if a whole-day series is requested, clear the start/end times
return e&&(d=a.extend({},f,"object"==typeof e?e:{})),d?(b&&(d.start=null,d.end=null),x(t(d),g.start,g.end)):[]}
// Determines if the given event can be relocated to the given span (unzoned start/end with other misc data)
function B(a,b){var d=b.source||{},e=_(b.constraint,d.constraint,c.eventConstraint),f=_(b.overlap,d.overlap,c.eventOverlap);return E(a,e,f,b)}
// Determines if an external event can be relocated to the given span (unzoned start/end with other misc data)
function C(b,c,d){var e,f;
// note: very similar logic is in View's reportExternalDrop
return d&&(e=a.extend({},d,c),f=x(t(e))[0]),f?B(b,f):D(b)}
// Determines the given span (unzoned start/end with other misc data) can be selected.
function D(a){return E(a,c.selectConstraint,c.selectOverlap)}
// Returns true if the given span (caused by an event drop/resize or a selection) is allowed to exist
// according to the constraint/overlap settings.
// `event` is not required if checking a selection.
function E(a,b,c,d){var e,f,g,h,i,j;
// the range must be fully contained by at least one of produced constraint events
if(null!=b){for(e=F(b),f=!1,h=0;h<e.length;h++)if(G(e[h],a)){f=!0;break}if(!f)return!1}for(g=I.getPeerEvents(a,d),h=0;h<g.length;h++)
...
function F(a){return"businessHours"===a?A():"object"==typeof a?x(t(a)):s(a)}
// Does the event's date range fully contain the given range?
// start/end already assumed to have stripped zones :(
function G(a,b){var c=a.start.clone().stripZone(),d=I.getEventEnd(a).stripZone();return b.start>=c&&b.end<=d}
// Does the event's date range intersect with the given range?
// start/end already assumed to have stripped zones :(
function H(a,b){var c=a.start.clone().stripZone(),d=I.getEventEnd(a).stripZone();return b.start<d&&b.end>c}// assumed to be a calendar
var I=this;
// exports
I.isFetchNeeded=d,I.fetchEvents=e,I.addEventSource=h,I.removeEventSource=j,I.updateEvent=n,I.renderEvent=q,I.removeEventSources=k,I.removeEvents=r,I.clientEvents=s,I.mutateEvent=y,I.normalizeEventDates=v,I.normalizeEventTimes=w;
// imports
var M,N,O=I.reportEvents,P={events:[]},Q=[P],R=0,S=0,U=[];// holds events that have already been expanded
a.each((c.events?[c.events]:[]).concat(c.eventSources||[]),function(a,b){var c=i(b);c&&Q.push(c)}),/* Business Hours
	-----------------------------------------------------------------------------------------*/
I.getBusinessHoursEvents=A,/* Overlapping / Constraining
	-----------------------------------------------------------------------------------------*/
I.isEventSpanAllowed=B,I.isExternalSpanAllowed=C,I.isSelectionSpanAllowed=D,I.getEventCache=function(){return U}}
// updates the "backup" properties, which are preserved in order to compute diffs later on.
function Sa(a){a._allDay=a.allDay,a._start=a.start.clone(),a._end=a.end?a.end.clone():null}var Ta=a.fullCalendar={version:"2.7.2",internalApiVersion:3},Ua=Ta.views={};Ta.isTouch="ontouchstart"in document,a.fn.fullCalendar=function(b){var c=Array.prototype.slice.call(arguments,1),d=this;// what this function will return (this jQuery object by default)
